...
(function (sunui) {
    var AbstractPopupCommand = /** @class */ (function (_super) {
         ...
         * 应用展示缓动
         */
        AbstractPopupCommand.prototype.$showProps = function (view, props, duration) {
            if (props.x !== void 0) {
                view.x = props.x;
            }
            ;
            ...
            if (duration == 0) {
                ...
                if (props.left === void 0 && props.right === void 0 && props.top === void 0 && props.bottom === void 0) {
                    view.alpha = 0;
                    props.alpha = sunui.Tween.Alpha.MAX;
                    view.scaleX = 0;
                    view.scaleY = 0;
                    props.scaleX = 1;
                    props.scaleY = 1;
                }
                sunui.Tween.get(view).to(props, duration);
            }
        };
        /**
         * 应用关闭缓动
         */
        AbstractPopupCommand.prototype.$closeProps = function (view, props, duration) {
            // 从左或右滑出
            if (props.left !== void 0) {
